...
def get_date_keyboard(day, month, year):
    return [
            [InlineKeyboardButton(f"{messages['day']['ru']} / {messages['day']['uz']}", callback_data=-1),],
            [
            ...
            [InlineKeyboardButton(f"{messages['month']['ru']} / {messages['month']['uz']}", callback_data=-2),],
            [
            ...
            [InlineKeyboardButton(f"{messages['year']['ru']} / {messages['year']['uz']}", callback_data=-3),],
            [
...
def get_time_keyboard(hour, minute, state):
    return [
            [InlineKeyboardButton(f"{messages['hours']['ru']} / {messages['hours']['uz']}", callback_data=-1),],
            [
            ...
            [InlineKeyboardButton(f"{messages['minutes']['ru']} / {messages['minutes']['uz']}", callback_data=-2),],
            [
